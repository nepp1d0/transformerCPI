...
class Encoder(nn.Module):
    ...
    def forward(self, protein):
        ...
        #print(f'[DEBUG] Decoder first taking input: {protein.shape}')
        conv_input = self.fc(protein)
        #print(f'[DEBUG] Decoder the after self.fc it is: {conv_input.shape}')
        ...
        #print(f'[DEBUG] Decoder output is: {conved.shape}')
